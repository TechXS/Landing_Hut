      ...
      <div className="properties">
        <Container>
          ...
          <p className="gray-50 mb-5">
            Discover a seamless way to transition from your current home to your
            next dream abode while landlords effortlessly market their vacant
            properties. Our platform ensures smoother moves, better occupancy
            rates, and a hassle-free experience for everyone involved. Say
            goodbye to the stress of moving and hello to a world where your next
            perfect home is just a click away. Join our community and experience
            the ultimate convenience in home transitions today!
          </p>
          {/* Start tabs */}

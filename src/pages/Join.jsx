        ...
        >
          ...
          <SwiperSlide className="py-4 px-3 align-items-start flex-column">
            ...
            >
              ...
              <AnimationTitles title="Reports" className=" mb-4 mt-5 h4" />
              <p className="gray-50">
          ...
          <SwiperSlide className="py-4 px-3 align-items-start flex-column">
            ...
            >
              ...
              <AnimationTitles title="Properties" className=" mb-4 mt-5 h4" />
              <p className="gray-50">
          ...
          <SwiperSlide className="py-4 px-3 align-items-start flex-column">
            ...
            >
              ...
              <AnimationTitles title="Maintenance" className=" mb-4 mt-5 h4" />
              <p className="gray-50">
                Streamline maintenance requests for quick and effective
                resolutions.
              </p>
            </a>
          </SwiperSlide>
